...
class Reserva(models.Model):
    ...
    cliente = models.ForeignKey(Cliente, on_delete=models.CASCADE, related_name='reservas', verbose_name='Cliente')
    mesa = models.ForeignKey(Mesa, on_delete=models.CASCADE, related_name='reservas', verbose_name='Mesa')
